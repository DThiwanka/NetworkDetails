  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="text-center text-2xl sm:text-5xl shadow-sm ">
        ...
        <div className='flex flex-col sm:flex-row gap-10 sm:gap-20 mt-10 sm:mt-20 text-xl'>
          <button className="bg-blue-500 sm:bg-black hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow-lg">
